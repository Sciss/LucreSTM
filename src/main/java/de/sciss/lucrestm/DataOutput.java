...
import de.sciss.lucrestm.util.FastOutputStream;
import de.sciss.lucrestm.util.PackedInteger;
import de.sciss.lucrestm.util.UtfOps;
 ...
 * <ul>
 * <li>{@link DataOutput#writeSortedFloat}</li>
 * <li>{@link DataInput#readSortedFloat}</li>
 * <li>{@link DataOutput#writeSortedDouble}</li>
 * <li>{@link DataInput#readSortedDouble}</li>
 * </ul>
 *
 * <p>To use integer-bit representation use this set of methods:</p>
 * <ul>
 * <li>{@link DataOutput#writeFloat}</li>
 * <li>{@link DataInput#readFloat}</li>
 * <li>{@link DataOutput#writeDouble}</li>
 * <li>{@link DataInput#readDouble}</li>
 * </ul>
 *
 * @author Mark Hayes
 */
public class DataOutput extends FastOutputStream {
     ...
     * Writes values that can be read using {@link DataInput#readBytes}.
     ...
     */
    public final DataOutput writeBytes(String val) {
     ...
     * Writes values that can be read using {@link DataInput#readChars}.
     *
     ...
     * @throws NullPointerException if the val parameter is null.
     */
    public final DataOutput writeChars(String val) {
     ...
     * Writes values that can be read using {@link DataInput#readString()}.
     *
     * @param val is the string containing the characters to be written.
     *
     * @return this tuple output object.
     */
    public final DataOutput writeString(String val) {
     ...
     * Writes values that can be read using {@link DataInput#readChar}.
     *
     * @param val is the value to write to the buffer.
     *
     * @return this tuple output object.
     */
    public final DataOutput writeChar(int val) {
     ...
     * Writes values that can be read using {@link DataInput#readBoolean}.
     *
     * @param val is the value to write to the buffer.
     *
     * @return this tuple output object.
     */
    public final DataOutput writeBoolean(boolean val) {
     ...
     * Writes values that can be read using {@link DataInput#readByte}.
     *
     * @param val is the value to write to the buffer.
     *
     * @return this tuple output object.
     */
    public final DataOutput writeByte(int val) {
     ...
     * Writes values that can be read using {@link DataInput#readShort}.
     *
     * @param val is the value to write to the buffer.
     *
     * @return this tuple output object.
     */
    public final DataOutput writeShort(int val) {
     ...
     * Writes values that can be read using {@link DataInput#readInt}.
     *
     * @param val is the value to write to the buffer.
     *
     * @return this tuple output object.
     */
    public final DataOutput writeInt(int val) {
     ...
     * Writes values that can be read using {@link DataInput#readLong}.
     *
     * @param val is the value to write to the buffer.
     *
     * @return this tuple output object.
     */
    public final DataOutput writeLong(long val) {
     ...
     * Writes values that can be read using {@link DataInput#readFloat}.
     ...
     * @return this tuple output object.
     */
    public final DataOutput writeFloat(float val) {
     ...
     * Writes values that can be read using {@link DataInput#readDouble}.
     ...
     * @return this tuple output object.
     */
    public final DataOutput writeDouble(double val) {
     ...
     * Writes values that can be read using {@link DataInput#readSortedFloat}.
     *
     ...
     * @return this tuple output object.
     */
    public final DataOutput writeSortedFloat(float val) {
     ...
     * Writes values that can be read using {@link DataInput#readSortedDouble}.
     *
     ...
     * @return this tuple output object.
     */
    public final DataOutput writeSortedDouble(double val) {
     ...
     */
    public final DataOutput writeBytes(char[] chars) {
     ...
     * @throws NullPointerException if the chars parameter is null.
     */
    public final DataOutput writeChars(char[] chars) {
     ...
     * to UTF format.
     * Note that zero (0x0000) character values are encoded as non-zero values.
     * Writes values that can be read using {@link DataInput#readString(int)}
     * or {@link DataInput#readString(char[])}.
     *
     * @param chars is the array of characters to be written.
     *
     * @return this tuple output object.
     ...
     * @throws NullPointerException if the chars parameter is null.
     */
    public final DataOutput writeString(char[] chars) {
     ...
     * @return this tuple output object.
     */
    public final DataOutput writeUnsignedByte(int val) {
     ...
     * @return this tuple output object.
     */
    public final DataOutput writeUnsignedShort(int val) {
     ...
     * Writes values that can be read using {@link
     * DataInput#readUnsignedInt}.
     *
     * @param val is the value to write to the buffer.
     *
     * @return this tuple output object.
     */
    public final DataOutput writeUnsignedInt(long val) {
     ...
     */
    private final DataOutput writeUnsignedLong(long val) {
     ...
     */
    public final DataOutput writeBigInteger(BigInteger val) {
     ...
     *
     * @see DataOutput#writeBigInteger
     */
